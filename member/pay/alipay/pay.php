...
$pay = $this->ci->get_cache('member', 'setting', 'pay', 'alipay');

$alipay_config['key'] = $pay['key'];
$alipay_config['partner'] = $pay['id'];
$alipay_config['sign_type'] = 'MD5';
$alipay_config['transport'] = 'http';
$alipay_config['return_url'] = SITE_URL.'member/pay/alipay/return_url.php';
$alipay_config['notify_url'] = SITE_URL.'member/pay/alipay/notify_url.php';
...
if ($this->mobile && $pay['wap']) {
    ...
    $alipay_config['return_url'] = SITE_URL.'member/pay/alipay/wap_return_url.php';
    $alipay_config['notify_url'] = SITE_URL.'member/pay/alipay/wap_notify_url.php';

    require_once(FCPATH.'member/pay/alipay/wap/alipay_submit.class.php');
