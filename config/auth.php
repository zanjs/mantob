...
$config['auth'][] = array(
	...
	'auth' => array(
        ...
        'admin/route/index' => lang('html-503'),
        'admin/db/index' => lang('031'),
...
$config['auth'][] = array(
	...
	'auth' => array(
		...
		'admin/application/delete' => lang('del'),
	)
);
...
$config['auth'][] = array(
	'name' => lang('340'),
	'auth' => array(
		'admin/downservers/index' => lang('admin'),
		'admin/downservers/add' => lang('add'),
		'admin/downservers/edit' => lang('edit'),
		'admin/downservers/del' => lang('del'),
	)
);
...
$config['auth'][] = array(
	...
	'auth' => array(
		...
		'member/admin/space/init' => lang('351'),
	)
);
...
$config['auth'][] = array(
    'name' => lang('202'),
    'auth' => array(
        'member/admin/sns/index' => lang('041'),
        'member/admin/sns/topic' => lang('201'),
        'member/admin/content/del' => lang('del')
    )
);